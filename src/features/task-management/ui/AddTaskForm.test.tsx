...
import { BOARD_MAIN_ID, COLUMN_TODO_ID } from '@/test/fixtures/kanbanFixtures'
...
describe('AddTaskForm', () => {
  it('creates_a_task_when_submitting_a_valid_title', () => {
    ...
    const before = useKanbanStore.getState().tasksByBoard[BOARD_MAIN_ID][COLUMN_TODO_ID].length
    ...
    expect(useKanbanStore.getState().tasksByBoard[BOARD_MAIN_ID][COLUMN_TODO_ID]).toHaveLength(
      before + 1,
    )
